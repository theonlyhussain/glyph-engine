...
export function runAutoCalibratorTests() {
  ...
  assert(
    result085.brightness >= 1.0,
    `Bright video (avgLum = 0.85) outputs brightness >= 1.0 (got ${result085.brightness})`
  );
  assert(
    result085.brightness === 1.2,
    `Bright video (avgLum = 0.85) expected brightness 1.20 (got ${result085.brightness})`
  );
  ...
  assert(
    result095.brightness >= 1.0,
    `Bright video (avgLum = 0.95) outputs brightness >= 1.0 (got ${result095.brightness})`
  );
  assert(
    result095.brightness === 1.25,
    `Bright video (avgLum = 0.95) expected brightness 1.25 (got ${result095.brightness})`
  );
  ...
  assert(
    result100.brightness >= 1.0,
    `Pure white video (avgLum = 1.0) outputs brightness >= 1.0 (got ${result100.brightness})`
  );
  ...
  assert(
    result045.brightness === 1.0,
    `Threshold video (avgLum = 0.45) expected brightness 1.0 (got ${result045.brightness})`
  );
  ...
  assert(
    result020.brightness === 2.25,
    `Dark video (avgLum = 0.20) expected brightness 2.25 (got ${result020.brightness})`
  );
