export class AutoCalibrator {
     ...
     */
    static calculateSettings(avgLum, avgStd, avgSat, avgDetail) {
     ...
     */
    static async sampleFrame(video, time) {
        // Seek and wait
        await new Promise((resolve) => {
        ...
        let lumSum = 0;
        let satSum = 0;
        const lumValues = new Array(totalPixels);
